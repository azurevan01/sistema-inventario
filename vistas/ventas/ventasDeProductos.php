...
<div class="row">
	<div class="col-sm-4">
		<form id="frmVentasProductos">
			...
			<input type="text" class="form-control input-sm" id="articuloV" name="articuloV">
			<p></p>
			<span class="btn btn-primary" id="btnAgregaVenta">Agregar Producto</span>
			<span class="btn btn-danger" id="btnVaciarVentas">Vaciar Producto</span>
		</form>
	</div>
	<div class="col-sm-3">
