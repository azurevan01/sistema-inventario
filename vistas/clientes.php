			...
			<div class="row">
				<div class="col-sm-4">
					<form id="frmClientes">
						...
						<input type="text" class="form-control input-sm" id="unidad_departamento" name="unidad_departamento">
			...
			<div class="modal-dialog modal-sm" role="document">
				<div class="modal-content">
					<div class="modal-header">
						...
						<h4 class="modal-title" id="myModalLabel"><center>Actualizar Unidad <br>o <br>Departamentos</center></h4>
					</div>
					<div class="modal-body">
						<form id="frmClientesU">
							...
							<label>Departamento</label>
							<input type="text" class="form-control input-sm" id="unidad_departamentoU" name="unidad_departamentoU">
							<label>Direccion</label>
		...
		function agregaDatosCliente(idcliente){
			...
			$.ajax({
				...
				success:function(r){
					...
					$('#unidad_departamentoU').val(dato['unidad_departamento']);
