    ...
    <div class="navbar navbar-inverse navbar-fixed-top" data-spy="affix" data-offset-top="100">
      <div class="container">
        <div class="navbar-header">
          ...
          <a class="navbar-brand" href="inicio.php"><img class="img-responsive logo img-thumbnail" src="../img/innovattia.png" alt="" width="100px" height="100px"></a>
        </div>
        ...
        if($_SESSION['usuario']=="admin"):
         ...
         <?php 
          ...
          ?>
           ...
           <li><a href="clientes.php"><span class="glyphicon glyphicon-tag"></span> Agregar Usuario<br> de Departamento</a>
          </li>
          <li><a href="ventas.php"><span class="glyphicon glyphicon-send"></span> Salida <br>de Productos</a>
          </li>
